        ...
        <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-14 px-6 lg:grid-cols-[0.96fr_1.04fr]">
          <div className="max-w-3xl">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <Link
                href="/case-studies"
                className="group inline-flex items-center justify-center gap-3 rounded-full bg-[#2563EB] px-7 py-4 text-sm font-bold uppercase tracking-widest text-white shadow-[0_8px_32px_rgba(37,99,235,0.25)] transition-all hover:-translate-y-0.5 hover:bg-[#1D4ED8]"
              >
                View Case Studies
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center rounded-full border border-[#E2E8F0] px-7 py-4 text-sm font-bold uppercase tracking-widest text-[#64748B] transition-all hover:border-[#2563EB]/40 hover:text-[#0F172A]"
              >
                Discuss a Project
              </Link>
            </div>
          ...
          {/* Right panel — agency map + logo constellation */}
