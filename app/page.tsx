    ...
    <main className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="relative bg-white">
        ...
        <div className="flex justify-center pb-24 -mt-4 relative z-10">
          <Link
            href="/services"
            className="group inline-flex items-center gap-2.5 text-[11px] font-bold tracking-widest uppercase text-[#64748B] hover:text-[#0F172A] border border-[#E2E8F0] hover:border-[#2563EB]/40 bg-white hover:shadow-[0_4px_16px_rgba(37,99,235,0.08)] px-6 py-3 rounded-full transition-all duration-300"
          >
            View All Services
            <ArrowRight size={13} className="group-hover:translate-x-1 transition-transform duration-300 text-[#2563EB]" />
          </Link>
        </div>
      </section>
