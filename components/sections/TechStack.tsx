      ...
      <div className="relative w-full">
        ...
        >
          {doubled.map((tech, i) => (
            <div
              key={i}
              className="shrink-0 bg-[#111827] border border-[#1E293B] rounded-2xl px-8 py-4 text-base font-bold text-[#64748B] hover:text-[#F8FAFC] hover:border-[#2563EB]/50 transition-all cursor-default whitespace-nowrap"
            >
              {tech}
            </div>
          ))}
