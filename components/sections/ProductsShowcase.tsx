        ...
        <AnimatePresence mode="wait">
          {products.map((product) => (
            activeProduct === product.id && (
              <TabsContent key={product.id} value={product.id} forceMount>
                <motion.div
                ...
                >
                  ...
                  <div className="flex-1 relative z-10 text-center lg:text-left">
                    ...
                    {product.highlights && (
                      <ul className="grid grid-cols-2 gap-x-6 gap-y-3 mb-10 text-left max-w-md mx-auto lg:mx-0">
                  ...
                  <div className="w-full lg:w-1/3 aspect-square bg-[#0A1628] rounded-2xl border border-[#1E293B] flex items-center justify-center relative z-10 p-12 overflow-hidden">
                    {product.logo ? (
