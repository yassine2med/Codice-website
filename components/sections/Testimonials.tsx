...
export default function Testimonials() {
  return (
    <section id="testimonials" className="py-24 px-6 bg-[#0A1628] overflow-hidden">
            ...
            {testimonials.map((t, i) => (
              <CarouselItem key={i}>
                <div className="relative bg-[#111827] border border-[#1E293B] rounded-2xl p-12 md:p-16 text-center group transition-all duration-500 hover:border-[#2563EB]/50">
                  <div className="absolute top-8 left-8 text-[#2563EB]/5 group-hover:text-[#2563EB]/10 transition-colors">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      {t.photo && (
                        <div className="w-14 h-14 rounded-full overflow-hidden mb-4 border-2 border-[#1E293B]">
                          <Image
                            src={t.photo}
                            alt={t.name}
                            width={56}
